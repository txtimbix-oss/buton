...
useSeoMeta(() => ({
  ...
  description: `Подробные советы по продлению свежести букетов: обрезка стеблей, вода, удобрение, режим хранения. Фото перед отправкой и гарантия свежести от «Бутон».`,
